// Forked from packages/tui keybind for the --mini UI. The full terminal UI
// was removed; this table is kept so existing tui.json keybind overrides keep
// validating. Many commands have no --mini binding and are inert here.
export * as MiniKeybind from "./keybind"
