...
export const TuiThreadCommand = cmd({
  command: "$0 [project]",
  describe: "start opencode (terminal UI removed, use web or desktop)",
  builder: (yargs) =>
  ...
  handler: async (args) => {
    ...
    UI.error("The terminal UI has been removed. Use `opencode web`, the desktop app, or `opencode --mini`.")
    process.exitCode = 1
  },
})
