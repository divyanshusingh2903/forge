...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Forge.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Forge.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Forge.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Forge can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Forge could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Forge.",
  ...
  "help.tabs.introduction": "Forge Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "context.usage.openDetails": "Open detailed breakdown",
  ...
  "toast.update.description": "A new version of Forge ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Forge team",
  ...
  "session.plan.empty.title": "No plan yet",
  "session.plan.empty.description": "Switch to Plan mode and describe what you want built — the plan will appear here.",
  ...
  "session.plan.interrupted.withPlan": "The app restarted before you answered. Your plan is still here — recover it to continue.",
  "session.plan.interrupted.noPlan": "The app restarted before the plan was ready. Recover to clear the stuck indicator and keep planning.",
  ...
  "sidebar.gettingStarted.line1": "Forge includes free models so you can start immediately.",
  ...
  "settings.desktop.builtOn": "Built on OpenCode",
  ...
  "settings.general.row.language.description": "Change the display language for Forge",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Forge looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Forge follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Forge is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Forge launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Forge.",
